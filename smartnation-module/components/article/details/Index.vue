...
<template>
  <div>
    <ArticleDetailsHeadingTitle :title="post?.title.rendered" />
    <ArticleDetailsInfo :created="post?.date_gmt" :total-comments="5" :total-views="100" class="mb-3" />
    <ArticleDetailsContent :post="post" />
  </div>
</template>
