...
const props = defineProps({ images: { type: String }, alt: { type: String, default: 'Cover Artikel' } })

</script>


<template>
  <div class="article-details__content__cover__wrapper mb-3">
    <NuxtImg class="img-fluid article-details__cover" :src="images" :height="433" :alt="alt" />
  </div>
</template>
