...
defineProps({ posts: { type: Object as PropType<PostsDataType> }, title: { type: String, default: '' } })
...
<template>
  <div>
    <div class="d-flex flex-column pt-3">
      <ContentNewArticleHeading :title="title" :class="'text-decoration-underline text-danger mb-3'" />
