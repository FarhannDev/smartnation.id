...
import { CategoryPostsType, categories } from '~/utils/data/getInitialCategoryPostData';
    ...
    <section class="albums-section-container py-5">
      <div class="container px-3 px-md-0 px-lg-0">
        <div class="row justify-content-start g-3">
          <div v-for="category in categoriesData" :key="category.id" class="col-xl-4 col-lg-4 col-md-6" data-aos="fade-up"
            data-aos-duration="1500">
            <GalleryCardAlbum :title="category.name" :created="'20 December 2023'"
              :albumImage="'https://drive.google.com/uc?export=download&id=1cDzj6ZUrHyGEAeXzh2P-3AjWwUonmtqc'" :total="10"
              :class="'mb-3'" />
          </div>
        </div>
      </div>
