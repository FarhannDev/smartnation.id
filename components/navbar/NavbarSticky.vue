...
<template>
  <nav :class="`navbar navbar-expand-xl fixed-top`">
    <div class="container">
      ...
      <!-- toggler navigasi -->
      <button class="navbar-toggler border-0 d-lg-none d-xl-none d-xxl-none" type="button" data-bs-toggle="collapse"
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <NuxtLink :class="`nav-link mx-md-2  ${route.path === '/about' ? 'active' : ''
              }`" to="/about">Tentang Kami
            </NuxtLink>
          </li>
          <li class="nav-item">
            <NuxtLink :class="`nav-link mx-md-2  ${route.path === '/contact' ? 'active' : ''
