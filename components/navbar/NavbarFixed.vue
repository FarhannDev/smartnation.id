    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
          <li class="nav-item">
            <NuxtLink
              :class="`nav-link mx-md-2 ${route.path === '/' ? 'active' : ''}`"
              aria-current="page"
              to="/"
              >Beranda
            </NuxtLink>
        ...
        <div class="hstack gx-2">
          ...
          <div class="dropdown">
            <button
              ...
              class="btn border-0 translate__button"
              type="button"
          ...
          <div
            @mouseenter="showDropdownTranslate(true)"
            @mouseleave="showDropdownTranslate(false)"
            class="dropdown"
          >
            <button
              class="btn border-0 translate__button px-0 mx-0"
              type="button"
              data-bs-toggle="dropdown"
              aria-expanded="false"
            >
