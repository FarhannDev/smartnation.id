      ...
      <li v-for="event in events" :key="event.id" class="list-group-item mx-0 px-0">
        <div class="card border-0 rounded-0">
          <div class="row justify-content-start align-items-center g-3">
            <div class="col-xl-4 col-xxl-3 col-lg-4 col-md-auto">
              <NuxtLink :to="`/events/${event.slug}`" :aria-label="`Baca Selengkapnya ${event.title.rendered}`">
                <NuxtImg :class="'article-list__thumbnail '" :src="event.featured_media" loading="lazy"
                  :alt="event.title.rendered" />
              </NuxtLink>
            </div>
            <div class="col-xl-8 col-xxl-9 col-lg-8 col-md-auto">
              <div class="card-body px-0 mx-0 px-lg-2 mx-lg-2">
