...
<template>
  <div v-if="posts" v-for="post in posts" :key="post.id" class="col-lg-6 col-md-6">
    <div class="card border-0 rounded-0 mb-3">
      <NuxtLink :to="`/${post.slug}`" :aria-label="`Baca Selengkapnya ${post.title.rendered}`">
        <NuxtImg :class="'card-img-top img-fluid rounded article-thumbnail'" :src="post.featured_media" :height="253"
