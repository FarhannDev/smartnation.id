    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <NuxtLink @click="toggleMenu" :class="`nav-link mx-md-1  ${route.path === '/maintenance' || route.path === `/maintenance/${route.params.id}` ? 'active' : ''
              }`" to="/maintenance">Media
            </NuxtLink>
          </li>
          <li class="nav-item">
      ...
      <div class="d-none d-lg-none d-xl-block d-xxl-block">
        <div class="hstack gx-2">
          ...
          <ButtonToggleColorMode />
          <ButtonTranslateGoogleTranslateButtonFixed />
        </div>
      </div>
    </div>
  </nav>
